...
from lecture.views.admin import GetLectureAPI, GetLectureByNameAPI, EditLectureAPI, EditProblems
...
urlpatterns = [
    ...
    url(r'edit-problems/?$', EditProblems.as_view(), name="edit-problems"),
